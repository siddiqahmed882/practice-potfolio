  ...
  return (
    <>
      <h2 className="head-text">
        My creative <span>Porfoltio</span>
      </h2>
      ...
      >
        {filterWorks.length ? filterWorks.map((work, index) => (
          ...
          <div>
            <img src={images.emptySvg} className="no-data-to-show" />
            <p className="p-text">Nothing to show for now...</p>
          </div>
        )}
      </motion.div>
    </>
